    ...
    data() {
        return {
            ...
            menus: [
                ...
                { separator: true },
                { to: "/themes?category=official", label: "ธีมไลน์ทางการ" },
                { to: "/themes?category=creator", label: "ธีมไลน์ครีเอเตอร์" },
                { separator: true },
                { to: "/emojis?category=official", label: "อิโมจิไลน์ทางการ" },
                {
...
<style>
/** ธงชาติ */
@import "@/public/css/freakflags/freakflags.css";
</style>
